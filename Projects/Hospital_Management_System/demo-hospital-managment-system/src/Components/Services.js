...
import HSpecialties from "./HSpecialties";
    ...
    <>
      ...
      <div className="container-fluid p-5">
        ...
        <div className="bg-warning rounded-4">
          <div className="row d-flex flex-wrap justify-content-evenly p-2">
              ...
              ServiceData.map((currentVal) => {
                return (
                  ...
                  {/* <div className="col card-section" style={{ width: "18rem",border: "20px solid red"}}> */}
                    {/* <div className="card rounded-4 bg-warning" style={{ width: "18rem", border: "1px,solid red" }}> */}
                    <div  className="card  rounded-4 bg-warning shadow p-3 mb-5 bg-body-tertiary " style={{ width: "18rem", height:"20rem", border: "1px,solid red" }}>
                      <img
                      ...
                      <div className="card-body">
                        ...
                        {currentVal.name}
                        {/* <a className="btn btn-primary" style={{ width: 'auto' }} href="#"role="button">Link{currentVal.name} */}
                        {/* </a> */}
                        </h3>
                        
                        {/* <h1>ranjit{currentVal.Accidental_Emergency.name}</h1> */}
                      </div>
                    </div>
                  </div>
